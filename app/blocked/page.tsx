...
const page = () => {
  return (
    <div className="er-pg">
      <div className="cdedd text-center">
        <div className="alnbase flex h-[53dvh] justify-center ">
          {/* <Image
        ...
        <div className="h38dd h-[38dvh]">
          <div>
            ...
            <p className="fnt-lexend fnt404 mb-3 pe-2 ps-2 text-font16 text-[#909496] md:text-[20px] lg:mb-[57px]">
              ...
              pixel is right where it should be.<br></br> Let’s get you back to
