...
export default function NotFound() {
  return (
    <div className={`${spaceGrotesk.className} er-pg`}>
        ...
        <div className="h-[38dvh] h38dd">
          <div>
            ...
            <p className="fnt-lexend fnt404 mb-3 pe-2 ps-2 text-font16 text-[#909496] md:text-[20px] lg:mb-[57px]">
              Looks like this page missed the mark. But don't worry—every
              other pixel is right where it should be.
              <br />
              Let's get you back to a flawless experience.
            </p>
            <div className="mt-4 flex justify-center">
              <Link
                href="/"
                className="p404 flex w-fit items-center justify-between gap-10 rounded-full border border-primary px-[25px] py-[15px] text-font16 uppercase leading-lh1p66 text-black transition-all duration-300 ease-in hover:shadow-lg"
              >
