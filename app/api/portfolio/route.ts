...
export async function POST(req: NextRequest) {
  ...
  const selectedHighlightForHome = formData.get(
    "selectedHighlightForHome",
  ) as string;
    ...
    if (section == "portfolio" || section == "case study new") {
      if (id) {
        ...
        await Portfolio.findByIdAndUpdate(id, {
          ...
          story,
          section2Image1:
            section2Image1 == null ? section2Image1Path : section2Image1,
          section2Image2:
            section2Image2 == null ? section2Image2Path : section2Image2,
          goals,
          objectives,
          challenge,
          solutions,
          ...
          result,
          section2BannerImage:
            section2BannerImage == null
              ? section2BannerImagePath
              : section2BannerImage,
        ...
        for (let i = 0; i < highlights.length; i++) {
          ...
          if (portfolioHighlight && portfolioHighlight.length > 0) {
            ...
            await PortfolioHighlight.create({
              ...
              text: highlights[i].text,
              customId: highlights[i].customId,
              companyId: highlights[i].companyId,
            });
          }
        }
      ...
      if (id) {
        ...
        hightLightIds.forEach((item: number) => {
          ...
          highlights.push({
            ...
            number,
            text,
            showInHome: selectedHighlightForHome == customId,
          });
        ...
        if (portfolio) {
          ...
          return NextResponse.json(
            { error: "Adding case study failed" },
            { status: 400 },
          );
        } else {
          return NextResponse.json(
