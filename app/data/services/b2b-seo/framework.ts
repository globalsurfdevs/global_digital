export const Frameworkdata = {
  ...
  data: [
    ...
    },
    {
      ...
      dec: "Through thorough keyword research, we find opportunities that attract the right audience—people genuinely interested in what you offer.",
    },
    {
      id: 5,
      title: "Optimize, Optimize, and Optimize Again",
      dec: "SEO isn’t a one-time task. We continuously optimize your site to secure and maintain strong search rankings.",
    },
    {
      id: 6,
      title: "Transparent Reporting",
      dec: "You deserve to see the results of your investment. Our detailed reports keep you informed about progress and ROI every step of the way.",
    },
    {
      id: 7,
