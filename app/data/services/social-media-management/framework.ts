export const Frameworkdata = {
  ...
  data: [
    ...
    },
    {
      ...
      dec: "Crafting posts that resonate and maintaining a consistent social presence.",
    },
    {
      id: 5,
      title: "Monitor & Optimize",
      dec: "Tracking performance and fine-tuning strategies for the best results.",
    },
    {
      id: 6,
      title: "Leverage Paid Ads",
      dec: "Running targeted ads to expand reach and achieve specific goals.",
    },
    {
      id: 7,
      title: "Foster Engagement",
      dec: "Building genuine connections to nurture a loyal and active community.",
    },
    {
      id: 8,
      title: "Analyze & Adapt",
