...
export const BannerSection = [
  {
    ...
    subtitle:
      "Creating Intuitive Mobile Applications for iOS and Android With Excellent User Experience",
    navigation: [
      { label: "Home", url: "/" },
...
export const Faq = [
  {
    ...
    description:
      "Mobile app development involves creating applications for mobile devices, including smartphones and tablets, to provide enhanced user experiences and business solutions. ",
  },
  {
    title: "Why should I invest in a mobile app? ",
    description:
      "A mobile app helps increase customer engagement, improve brand visibility, and enhance revenue opportunities by providing a direct connection to your users. ",
  },
  {
    title: "How long does it take to develop a mobile app? ",
    description:
      "The development timeline varies based on the complexity of the app, features, and integrations. On average, it takes 3-6 months to develop a fully functional app. ",
  },
  {
    title: "Do you develop both iOS and Android apps? ",
    description:
      "Yes, we specialize in both iOS and Android mobile app development, offering native and cross-platform solutions. ",
  },
  {
    title: "Can you redesign my existing mobile app? ",
    description:
      "Absolutely! Our team can enhance the UI/UX, performance, and functionality of your existing mobile app for a better user experience. ",
  },
  {
    title: "What industries do you serve? ",
    description:
      "We cater to various industries, including e-commerce, healthcare, finance, real estate, and more. ",
  },
  {
    title: "Do you provide post-launch support? ",
    description:
      "Yes, we offer ongoing maintenance, updates, and optimizations to ensure your mobile app remains competitive and high performing. ",
  },
  {
    title: "What tools do you use for mobile app development? ",
    description:
      "We utilize cutting-edge technologies such as Flutter, React Native, Swift, Kotlin, and more to build feature-rich mobile applications. ",
  },
];
