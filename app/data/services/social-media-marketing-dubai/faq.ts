export const Faq = [
  ...
  {
    title:
      " How do you optimize social media campaigns for better performance? ",
    description:
      "We use a data-driven approach to continuously optimize your social media campaigns. This includes refining targeting, testing different types of content, analyzing engagement, and adjusting strategies to improve performance. With our social media marketing services in Dubai, we focus on maximizing the impact of your social media presence for long-term success. ",
  },
  {
    title:
      " How long does it take to see results from social media campaigns? ",
    description:
      "Social media campaigns can start generating engagement almost immediately, but it typically takes a few weeks to see fully optimized results. We continuously monitor and adjust campaigns to ensure they’re performing at their best. With our social media marketing services packages, we ensure your campaigns are driving sustained growth over time. ",
  },
  {
    title:
      "What makes GS Digital different from other social media marketing agencies? ",
    description:
