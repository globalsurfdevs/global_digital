    ...
    subSections: [
      {
        ...
        listItems: [
          ...
          {
            label: "",
            description: "How-to questions and step-by-step guidance ",
          },
          {
            label: "",
            description:
...
export const GeoData = [
  {
    ...
    listItems: [
      {
        label:
          "<strong>Authoritative sourcing:</strong> cite data, regulations, and UAE-specific references. Content that references FTA guidelines, RERA regulations, or UAE Central Bank frameworks carries entity authority signals that AI systems trust.",
      },
      {
        label:
          "<strong>Structured content formats:</strong> use clear H2 and H3 headings formatted as questions, numbered steps, and definition-style opening sentences that AI models can extract and cite directly.",
      },
      {
        label:
          "<strong>Entity clarity:</strong> name your business, location, specialisation, and sector explicitly and consistently across all pages.",
      },
      {
        label:
          "<strong>Answer-first writing:</strong> open every key page or article with a direct 40 to 60-word answer to the primary question. AI systems prioritise extractable, standalone answers.",
      },
      {
        label:
          "<strong>Trust signals:</strong> author credentials, case studies, client testimonials, professional body memberships, and UAE regulatory compliance markers all strengthen the E-E-A-T profile that AI systems evaluate.",
      },
    ],
  },
];
...
export const Faq = [
  ...
  {
    title:
      "How do Google AI Overviews affect organic traffic for UAE businesses?",
    description:
  ...
  {
    title:
      "What is Generative Engine Optimisation (GEO) and how does it apply to UAE businesses?",
    description:
  ...
  {
    title:
      "Can I get my UAE business content cited inside Google AI Overviews?",
    description:
  ...
  {
    title:
      "How quickly can UAE businesses adapt their SEO strategy to account for AI Overviews?",
    description:
  ...
  {
    title:
      "Should UAE businesses invest more in paid search as a result of AI Overviews?",
    description:
