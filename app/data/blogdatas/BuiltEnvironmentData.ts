...
export const BannerSection = [
  {
    ...
    subtitle:
      "Building Strong Brand Identities With Creative Design, Marketing Collateral, and Storytelling",
...
export const videoProductionsocialData = [
  {
    ...
    listItems: [
      {
        label: "Buildings: ",
        description: "residential, commercial, industrial, hospitality ",
      },
      {
        label: "Infrastructure: ",
        description: "roads, bridges, utilities, power, drainage",
      },
      { label: "Public spaces: ", description: "parks, walkways, plazas  " },
      {
        label: "Systems: ",
        description: "transport networks, communications, urban planning  ",
      },
    ],
    paragraphs2: [
...
export const builtEnvironmentData = [
  {
    ...
    subSections: [
      ...
      },
      {
        ...
        paragraphs: [
          "At GS Digital, we consistently see that many built environment companies have strong technical expertise but struggle to communicate it effectively. ",
    ...
    listItems: [
      {
        ...
        description: "enables better coordination across project teams",
      },
      {
        label: "Digital twins ",
        description: "allow real-time monitoring and simulation of assets",
      },
      {
        label: "Drones ",
        description:
          "improve surveying accuracy and site inspection efficiency",
      },
      {
        label: "Artificial intelligence ",
        description:
          "supports planning, optimisation, and predictive maintenance ",
      },
    ],
    paragraphs2: [
...
export const contractorMarketingData = [
  {
    title:
      "Why contractor digital marketing matters for built environment companies in dubai and the UAE ",
    ...
    subSections: [
      ...
      {
        sectionSubtitle:
          "Most UAE construction companies have a weak digital presence",
        paragraphs: [
      ...
      {
        sectionSubtitle:
          "The first mover opportunity in construction marketing UAE",
        paragraphs: [
      ...
      {
        sectionSubtitle:
          "What an effective construction company website strategy looks like",
        paragraphs: [
          'For a <a href="https://www.globalsurf.ae/industry/construction" class="text-primary hover:underline">UAE construction or built environment company</a> , an effective online strategy means:',
    ...
    subSections: [
      {
        ...
        paragraphs: [
          "The UAE's national development visions set ambitious targets for carbon neutrality, smart city expansion, and transportation network growth. These are not aspirational statements. They are funded programmes with project pipelines attached to them, and they will shape public procurement priorities for the next decade and beyond. ",
        ],
      },
      {
        sectionSubtitle: "Mega-projects on the horizon",
        paragraphs: [
          "The Dubai Creek Tower, when complete, will redefine the city's skyline. Abu Dhabi's Saadiyat Island cultural district continues to expand. Sharjah, Ras Al Khaimah, and the Northern Emirates are all investing in tourism, residential, and infrastructure development at a scale that creates significant opportunity for contractors and consultants operating beyond Dubai and Abu Dhabi.",
        ],
      },
      {
        sectionSubtitle: "Technology integration accelerating",
        paragraphs: [
          "Autonomous vehicle adoption will reshape road design and parking infrastructure requirements. Drone delivery corridors are already being planned into UAE urban development frameworks. 5G and eventually 6G infrastructure will be embedded into new built environment projects from day one. These are not distant possibilities. They are active planning considerations in the UAE right now.  ",
...
export const Faq = [
  ...
  {
    title:
      "How is the UAE's built environment different from other countries? ",
    description:
