...
export const videoProductionsocialData = [
  {
    ...
    listItems: [
      ...
      { label: "Authentic:", description: "Casual, relatable tone." },
      {
        ...
        description: "Tailored format and engagement metrics.",
      },
    ],
    paragraphs2: [
...
export const videoTips = [
  ...
  },
  {
    ...
    keyDetails:
      'While consistency is key, avoid posting just for the sake of it. Use a simple content calendar and batch-produce videos with the help of a social media video production tool or with the support of a <a href="/content-production-agency-dubai" class="text-primary hover:underline">production agency</a>.',
  },
  {
