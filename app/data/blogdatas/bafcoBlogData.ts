    ...
    subSections: [
      {
        ...
        calloutText:
          "Most brands try to win in January. BAFCO prepared for it <br class='hidden lg:block'> throughout the year.",
        paragraphs2: [
    ...
    stats: [
      {
        value: "16",
        unit: "mo",
        description: "Continuous campaign management for BAFCO",
      },
      {
        value: "2",
        unit: "x",
        description: "Lead volume — same peak month, same budget",
      },
      {
        value: "56",
        unit: "%",
        description: "Reduction in cost per lead year on year",
      },
    ],
  },
];
