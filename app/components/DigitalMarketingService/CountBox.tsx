        ...
        <div className="grid grid-cols-1 gap-y-4 md:grid-cols-2 lg:grid-cols-3">
          {boxes.map((box, idx) => {
            ...
            return (
              <div
                key={box.label}
                className="group flex flex-col gap-2 border-r border-black/10 first:pl-0 last:border-r-0 lg:gap-8 lg:pl-10"
              ...
              >
                ...
                <p className="text-font25 font-normal leading-[1.3] text-gray1">
                  {box.label}
                </p>
              </div>
            );
