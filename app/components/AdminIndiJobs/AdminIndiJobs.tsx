...
const AdminIndiJob = ({ editMode }: { editMode?: boolean }) => {
  ...
  return (
    <form className="flex flex-col gap-2" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex w-full flex-col gap-2">
        ...
        />
        {errors.jobTitle && (
          <p className="text-red mt-1 text-sm">{errors.jobTitle.message}</p>
        )}
      </div>
      ...
      <div className="flex w-full flex-col gap-2">
        ...
        />
        {errors.team && (
          <p className="text-red mt-1 text-sm">{errors.team.message}</p>
        )}
      </div>
      ...
      <div className="flex w-full flex-col gap-2">
        ...
        {errors.description && (
          <p className="text-red mt-1 text-sm">{errors.description.message}</p>
        )}
      </div>
