...
const IndiServicePage = () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setValue(
          ...
          (data.data?.fifthSection?.items ?? []).map((item: any) => ({
            ...item,

            page:
              typeof item.page === "object" && item.page !== null
                ? item.page._id
                : (item.page ?? ""),
          })),
        );
  ...
  const fetchSubServices = async () => {
    try {
      const response = await fetch(`/api/sub-service?limit=1000`);
  ...
  useEffect(() => {
    Promise.all([
      ...
      fetchServiceIndustries(),

      fetchSubServices(),
    ]).then(() => fetchServiceData());
  }, []);
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <div className="flex flex-col gap-2">
                                ...
                                <Controller
                                  ...
                                  name={`fifthSection.items.${index}.page`}
            ...
            <div>
              ...
              <div className="mt-2 flex justify-end">
                <Button
                  ...
                  onClick={() =>
                    sixthSectionAppend({ title: "", description: "" })
                  }
                >
                  Add Item
                </Button>
            ...
            <div>
              ...
              <div className="mt-2 flex justify-end">
                <Button
                  ...
                  onClick={() =>
                    eighthSectionAppend({ title: "", description: "" })
                  }
                >
                  Add Item
                </Button>
                  ...
                  >
                    {ninethSectionItems.map((field, index) => (
                      ...
                      >
                        {reorderMode ? (
                          <span className="font-medium">
                            {watch(`ninethSection.items.${index}.title`) ||
                              `Item ${index + 1}`}
                          </span>
                        ) : (
                          <>
                            ...
                            <div className="flex flex-col gap-2">
                              <div className="flex flex-col gap-2">
                                ...
                                <Input
                                  ...
                                  {...register(
                                    `ninethSection.items.${index}.title`,
                                  )}
                                />
                              ...
                              <div className="flex flex-col gap-2">
                                ...
                                <Textarea
                                  ...
                                  {...register(
                                    `ninethSection.items.${index}.description`,
                                  )}
                                />
                              ...
                              <div className="flex flex-col gap-2">
                                ...
                                <Input
                                  ...
                                  {...register(
                                    `ninethSection.items.${index}.link`,
                                  )}
                                />
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input
                  ...
                  {...register(`eleventhSection.subTitle`)}
                />
            ...
            <div>
                  ...
                  >
                    {eleventhSectionItems.map((field, index) => (
                      ...
                      >
                        {reorderMode ? (
                          <span className="font-medium">
                            {watch(`eleventhSection.items.${index}.number`) ||
                              `Item ${index + 1}`}
                          </span>
                        ) : (
                          <>
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <Input
                                ...
                                {...register(
                                  `eleventhSection.items.${index}.number`,
                                )}
                              />
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <Input
                                ...
                                {...register(
                                  `eleventhSection.items.${index}.value`,
                                )}
                              />
              ...
              <div className="mt-2 flex justify-end">
                <Button
                  ...
                  onClick={() =>
                    eleventhSectionAppend({ number: "", value: "" })
                  }
                >
                  Add Item
                </Button>
                  ...
                  >
                    {caseStudySectionItems.map((field, index) => (
                      ...
                      >
                        {reorderMode ? (
                          <span className="font-medium">
                            {watch(`caseStudySection.items.${index}.project`) ||
                              `Item ${index + 1}`}
                          </span>
                        ) : (
                          <>
