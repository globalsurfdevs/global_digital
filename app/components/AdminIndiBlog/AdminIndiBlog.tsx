...
const AdminIndiBlog = ({ editMode }: { editMode?: boolean }) => {
  ...
  return (
    <form className="flex flex-col gap-2" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex w-full flex-col gap-2">
        ...
        />
        {errors.heading && (
          <p className="text-red mt-1 text-sm">{errors.heading.message}</p>
        )}
      </div>
      ...
      <div className="flex w-full flex-col gap-2">
        ...
        />
        {errors.category && (
          <p className="text-red mt-1 text-sm">{errors.category.message}</p>
        )}
      </div>
      ...
      <div>
        ...
        <TinyEditor
          ...
          blogContent={editMode && blogContent}
        />
        {/* <Controller
                    name={"content"}
                    control={control}
