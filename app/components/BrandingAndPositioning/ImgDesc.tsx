  ...
  return (
    <section className="py-8 xl:py-20 3xl:py-[100px]">
      <div className="container">
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2 xxl:gap-20 3xl:grid-cols-[auto_745px]">
          <motion.div
            variants={moveUp(0)}
            initial="hidden"
            whileInView="show"
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="mb-4 flex items-center gap-2 md:mb-6 xl:mb-8 xxl:mb-[81px]">
              <h2 className="text-28 uppercase leading-[1] tracking-[-0.025em] text-muted">
                {data.title}
              </h2>
              <div className="h-5 w-5 bg-primary"></div>
            </div>
            <h2 className="title-60 mb-4 tracking-[-0.025em] md:mb-5 xl:mb-10">
              {data.subTitle}
            </h2>
