            ...
            <div className='flex flex-col gap-3'>
                {jobs && jobs.length > 0 ? (jobs.map((item) => (
                    <div className='w-full relative'>
                        ...
                        <Link href={`/admin/jobs/${item._id}`} className="w-full h-32 flex flex-col items-center px-10 bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
