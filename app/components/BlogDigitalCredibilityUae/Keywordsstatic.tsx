  ...
  const steps = [
    {
      ...
      body: (
        <>
          On a site that is not yet optimised, ranking for a fiercely contested
          head term is not realistic in the early months. Begin with keyword
          research that surfaces specific, lower-competition terms you can
          genuinely win, build authority, and work toward the harder terms over
          time. This is the heart for{" "}
          <a
            href="https://www.globalsurf.ae/b2b-seo-agency-dubai"
            className="text-inherit underline underline-offset-2 transition-opacity hover:opacity-70"
          >
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="col-span-5 w-full">
              ...
              <p className="mt-4 text-font19 text-[#77787B]">
                ...
                we have refined across years of SEO work for built environment
                brands in the UAE, and the order matters as much as the steps.
              </p>
              ...
              {steps.map((step) => (
                <div key={step.number}>
                  ...
                  <p className="mt-4 text-font19 text-[#77787B]">{step.body}</p>
                </div>
              ))}
            </div>
          </div>
