  ...
  return (
    <>
      <div className="container mx-auto py-4">
        ...
        >
          <div className="flex flex-col  gap-4 pb-[50px] pt-[20px] sm:pt-[50px] lg:gap-[30px] lg:pb-[141px] lg:pt-[130px]">
            <motion.div
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.3 }} // Trigger animation once when 50% visible
            ...
            >
                  ...
                  <ul className="flex items-center space-x-2">
                    <React.Fragment>
                      <li>
                        <Link
                          href="/"
                          className="text-[10px] text-[#77787B] hover:underline sm:text-font14 lg:text-font19"
                        >
                          HOME
                        </Link>
                      </li>
                      ...
                      <li>
                        <span className="text-[10px] hover:underline sm:text-font14 lg:text-font19">
                          About Us
                        </span>
                      </li>
                    </React.Fragment>
              ...
              <div>
                <p className="text-small-30 max-w-[48ch] text-gray1">
