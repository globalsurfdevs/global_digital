...
const AddNews = ({ editMode }: { editMode?: boolean }) => {
  ...
  return (
    <>
      ...
      <div className="mt-5 flex h-full w-full flex-col">
        <div className="gap-x-15 flex h-full w-full">
          <form
            className="flex w-3/4 flex-col gap-y-5"
          ...
          >
            <div className="w-full">
              ...
              />
              {errors.title && (
                <p className="text-red mt-1 text-sm">{errors.title.message}</p>
              )}
            </div>
            <div className="w-full">
            ...
            <div className="flex w-full gap-3">
              ...
              />
              {errors.date && (
                <p className="text-red mt-1 text-sm">{errors.date.message}</p>
              )}
            </div>
          ...
          <div className="flex h-full w-1/4 items-center justify-center text-center">
            <div
