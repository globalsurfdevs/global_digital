  ...
  return (
    <div className="py-5">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="gap-x-15 mt-5 flex h-full w-full">
          <div className="flex w-3/4 flex-col gap-5">
            ...
            <div className="flex w-full flex-col gap-2">
              ...
              <input
                ...
                className={
                  "w-full rounded-md border bg-transparent py-1 pl-4 text-black"
                }
                readOnly={!editMode}
              />
              {errors.phone && (
          ...
          <div className="h-1/2 w-1/3">
            <div
              className="flex h-64 w-full cursor-pointer flex-col items-center justify-center overflow-hidden rounded-lg border-2 border-dashed border-gray-300"
