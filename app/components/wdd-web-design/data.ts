  ...
  data: [
    {
      id: 1,
      icon: assets.hwc1,
      dec: "Build a strong and impactful online presence.",
    },
    {
      id: 2,
      icon: assets.hwc2,
      dec: "Deliver a seamless and engaging user experience. ",
    },
    {
      id: 3,
      icon: assets.hwc3,
      dec: "Enhance visibility with optimized website performance.",
    },
    {
      id: 4,
      icon: assets.hwc4,
      dec: "Drive more leads and conversions through strategic design.",
    },
  ],
};
...
export const OurServices = {
  title: "Our Process - From Strategy to Launch  ",
  data: [
    {
      id: 1,
        title: "User Research",
...
export const AreaExpertise = {
  title: "Key Elements of our website design services ",
  data: [
    {
      id: 1,
      icon: assets.ke1,
      title: "Website Strategy ",
      desc: "Your website isn’t just about looks—it’s a powerful tool for growth. We design with purpose, ensuring every element aligns with your goals, enhances user experience, and drives engagement. A well-planned approach strengthens your brand and boosts conversions. ",
      url: "",
    },
    {
      id: 2,
      icon: assets.ke2,
      title: "UI/UX Design",
      desc: "Great design is about more than aesthetics—it’s about how users feel when they interact with your site. We create intuitive layouts, smooth navigation, and interactive elements that keep visitors engaged and encourage action. ",
      url: "",
    },
    {
      id: 3,
      ...
      desc: "Your audience is everywhere—on desktops, tablets, and phones. We make sure your website looks and works flawlessly across all devices, delivering a seamless experience no matter how users access it. ",
      url: "",
    },
    {
      id: 4,
      ...
      desc: "A stunning website is useless if no one can find it. We follow SEO best practices from the start, ensuring clear site structures, fast load times, and optimized visuals that improve search rankings and visibility. ",
      url: "",
    },
    {
      id: 5,
      ...
      desc: "Your website should feel like an extension of your brand. We create designs that reflect your identity—consistent colors, typography, and imagery—building trust and recognition with your audience. ",
      url: "",
    },
    {
      id:6,
