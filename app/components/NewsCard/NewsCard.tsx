    ...
    <Card sx={{ maxWidth: 345, borderRadius: "0.75rem" }}>
      ...
      <div className="flex w-full text-white">
        <div className="flex w-full text-2xl">
          <Link
            href={`/admin/news/edit-news/${data.id}`}
            className="flex w-1/2 items-center justify-center bg-black py-2"
          >
            <div>
              <FaRegEdit />
            </div>
          ...
          <div
            className="bg-red flex w-1/2 cursor-pointer items-center justify-center"
