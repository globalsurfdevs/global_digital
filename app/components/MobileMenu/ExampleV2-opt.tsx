...
import { Navigation } from "./NavigationV2-opt";
...
export const Example = ({
  ...
  React.useEffect(() => {
    console.log(isOpen);
    // This menu is now always rendered (hidden on desktop via CSS), so keep
    // the body style changes limited to the mobile viewport where it used to
    // be the only mounted header.
