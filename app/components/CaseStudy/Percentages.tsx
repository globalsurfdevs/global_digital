        ...
        <div className='container mx-auto py-4'>
            ...
            <div className='flex flex-col justify-between lg:gap-14 lg:gap-[100px] gap-[35px]'>
                <div className='flex flex-col group'>
                    <h1 className='text-primary title-65 pb-[19px] duration-500 group-hover:-translate-y-1'>30.43%</h1>
                ...
                <div className='flex flex-col group'>
                    <h1 className='text-primary title-65 pb-[19px] duration-500 group-hover:-translate-y-1'>2X</h1>
                    <div className='w-full bg-gray1 rounded-xl h-[1px] mb-[33px] duration-300 group-hover:-translate-y-1'></div>
