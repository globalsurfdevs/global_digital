...
const Goals = () => {
  return (
    <div className='container mx-auto py-4'>
        ...
        <div className='grid lg:grid-cols-2 border-t border-b lg:pt-10 lg:pb-20 py-6'>
            <div className='col-span-1 flex'>
                <h1 className='text-font65'>Goals</h1>
            </div>
            <div className='text-font19 pt-5 lg:pl-5'>
        ...
        <div className='grid lg:grid-cols-2 border-t lg:pt-10 lg:pb-20 py-6'>
            <div className='col-span-1 flex'>
        ...
        <div className='grid lg:grid-cols-2 lg:space-x-5 lg:py-12 space-y-5 md:space-y-0 py-6'>
