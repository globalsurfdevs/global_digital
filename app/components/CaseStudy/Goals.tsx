...
const Goals = () => {
  return (
    <div className='container mx-auto py-4'>
        ...
        <div className='grid grid-cols-2 border-t border-b pt-10 pb-20'>
            <div className='col-span-1 flex'>
                <h1 className='text-[65px]'>Goals</h1>
            </div>
            <div className='text-[19px] pt-5 pl-5'>
                Innovo Group partnered with Global Surf to achieve several key objectives for their website. 
        ...
        <div className='grid grid-cols-2 border-t border-b pt-10 pb-20'>
            <div className='col-span-1 flex'>
                <h1 className='text-[65px]'>Objectives</h1>
            </div>
            <div className='text-[19px] pt-5 pl-5'>
                To address goals, Global Surf conducted an in-depth analysis of the website&apos;s performance and speed. 
                ...
                a consistent and professional appearance across all touchpoints.
            </div>
        </div>


        <div className='grid grid-cols-2 border-t pt-10 pb-20'>
            <div className='col-span-1 flex'>
                <h1 className='text-[65px]'>Challenge</h1>
            </div>
            <div className='text-[19px] pt-5 pl-5'>
                Redesigning the website brought several challenges. Migrating from an outdated CMS without disruptions was complex, 
                ...
                looming, we delivered efficiently within tight deadlines.
            </div>
        </div>

        <div className='grid grid-cols-2 space-x-5 py-12'>
            
            <div className='bg-gray-200 flex flex-col w-full py-20 gap-8 px-14'>
            <div>
                <h1 className='text-[65px]'>Solutions</h1>
            </div>
            <div className='pl-4'>
            ...
            <div className='bg-gray-200 flex flex-col w-full py-20 gap-8 px-14'>
            <div>
                <h1 className='text-[65px]'>Key Achievements</h1>
            </div>
            <div className='pl-4'>
                <ul className='list-disc flex flex-col gap-8'>
