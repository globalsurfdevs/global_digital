...
const Ready = ({ data }: {
  ...
  return (
    <div className='container mx-auto py-4'>
      {data.caseStudy.image1 || data.caseStudy.image2 ? <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        <div className=' grid grid-cols-2 gap-[20px]'>
          ...
          {data.caseStudy.image1 && <div className=''>
            <Image src={data.caseStudy.image1} alt='image1' width={800} height={500} />
          </div>}

          {data.caseStudy.image2 && <div className=''>
            <Image src={data.caseStudy.image2} alt='image2' width={800} height={500} />
          </div>}
