    ...
    <>
      <div className='container mx-auto py-4'>
        ...
        <div className='lg:py-[142px] py-[50px] flex flex-col lg:w-[70%] gap-6'>
          ...
          <div className=''>
            <p className='text-19 text-gray1'>Seleo, a prominent Middle Eastern beverage brand, sought to expand its
          ...
          <div className={"flex h-full "}>
            <div className='flex flex-col  py-[50px] lg:py-[150px]  w-full lg:w-1/4'>
              ...
              <div className='border-b border-black flex flex-col  pb-[40px] mb-[36px]'>
                <h5 className='text-19 text-gray-400 pb-[5px]'>Industry</h5>
                <h4 className='text-30'>Food & Beverage</h4>
              </div>

              <div className='border-b border-black flex flex-col  pb-[40px] mb-[36px]'>
                <h5 className='text-19 text-gray-400 pb-[5px]'>Country</h5>
                <h4 className='text-30'>UAE, Kuwait, Qatar</h4>
              </div>

              <div className='border-black flex flex-col  '>
                <h5 className='text-19 text-gray-400 pb-[5px]'>Channels Used</h5>
