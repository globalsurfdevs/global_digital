...
const BlogList = ({
    ...
    const blogsByAuthor = allBlogs.filter(
        (b: any) => b.authorName?.toLowerCase() === authorName?.toLowerCase(),
    );

    return (
        <>
            <div className="container mx-auto py-4">
                <h2 className="text-[65px] leading-[70px] border-t xl:pt-[140px] pt-[70px]">Blogs</h2>
                <motion.div
                    initial="hidden"
                    whileInView="visible"
