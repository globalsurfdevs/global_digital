      ...
      <div className="flex min-h-[calc(100vh-200px)] flex-col gap-3">
        ...
        {selectedEnquiry && (
          ...
          >
            ...
            <div className="fixed inset-0 z-10 mt-20 w-screen overflow-y-auto">
              <div className="flex items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div className="relative flex transform flex-col gap-5 overflow-hidden rounded-lg bg-white p-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                  <div className="grid h-[300px] grid-cols-1 gap-4 overflow-auto text-sm">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-gray-900">
                        {selectedEnquiry.expectedSalary}
                      </span>
                    </div>
                    <div className="flex flex-col">
                      <label className="font-semibold text-gray-600">
                    ...
                    <div className="flex flex-col">
                      ...
                      <Link href={selectedEnquiry.resume} target="_blank">
                        <FaFilePdf />
                      </Link>
                    </div>
                  </div>
