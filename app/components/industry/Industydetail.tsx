...
const Industydetail: React.FC<ExpertiseSectionProps> = ({
  title,
  data,
  colnum,
  subttle,
                        ...
                        <div className=" overflow-hidden">
                          ...
                          >
                            ...
                            {/* <div className="border-b border-primary w-fit cntsmd hided-content max-h-0   overflow-hidden    text-white
                              ...
                              <p
                            className="uppercase text-16 fnt-lexend "
                          >Learm More
                          </p> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <g clip-path="url(#clip0_4002_1315)">
                            <path d="M18.7892 1.2749L0.699219 19.0149" stroke="#E63E31" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M0.699219 1.2749H18.7892V18.6649" stroke="#E63E31" stroke-width="2" stroke-miterlimit="10"/>
                            </g>
                            <defs>
                            <clipPath id="clip0_4002_1315">
