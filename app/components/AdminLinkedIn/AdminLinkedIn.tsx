...
const AdminLinkedIn = () => {
    ...
    const [selectedSubmission, setSelectedSubmission] = useState<LinkedinSubmission | null>(null);
                        ...
                        <table className="w-full text-left text-sm text-gray-700 dark:text-gray-300">
                            <thead className="bg-gray-100 text-xs uppercase text-gray-700 dark:bg-gray-800 dark:text-gray-300">
                                <tr>
                                    ...
                                    <th scope="col" className="px-4 py-3">LinkedIn URL</th>
                                    <th scope="col" className="px-4 py-3">Agreed</th>
                            ...
                            <tbody>
                                {submissions.map((item, i) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 font-medium text-gray-900 dark:text-white break-all">
                                ...
                                <div className="p-5 flex flex-col gap-5 relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                    <div className="grid grid-cols-1 gap-4 text-sm">
                                        <div className="flex flex-col">
                                            <label className="font-semibold text-gray-600">LinkedIn URL</label>

                                            <a href={selectedSubmission.linkedinUrl}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                        ...
                                        <div className="flex flex-col">
                                            <label className="font-semibold text-gray-600">Agreed to screening</label>
                                            <span className="text-gray-900">{selectedSubmission.agreed ? "Yes" : "No"}</span>
                                        </div>
                                        <div className="flex flex-col">
                                            <label className="font-semibold text-gray-600">Submitted on</label>
