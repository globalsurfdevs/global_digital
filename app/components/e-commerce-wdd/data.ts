  ...
  data: [
    {
      id: 1,
      icon: assets.wch5,
      dec: "Appealing designs to drive sales",
    },
    {
      id: 2,
      icon: assets.wch4,
      dec: "Intuitive and engaging user experiences  ",
    },
    {
      id: 3,
      icon: assets.wch3,
      dec: "Strong and scalable architecture for smooth operations ",
    },
    {
      id: 4,
      icon: assets.wch2,
      dec: "High-performing mobile solutions for seamless shopping",
    },
    {
      id: 5,
      icon: assets.wch1,
      dec: "Smooth connectivity with payment gateways, inventory systems, etc",
    },
  ],
};
...
export const Faq = [
  ...
  {
    title:
      "Do you provide Shopify and WooCommerce-specific development services? ",
    description:
      "Yes! Our Shopify experts and WooCommerce specialists in Dubai offer dedicated development, customization, and optimization services. ",
  },
];
...
export const Frameworkdata = {
  title: "Our E-Commerce Web Development Services  ",
  data: [
    {
      id: 1,
    ...
    } ,
    {
      ...
      dec: "Find what’s working and what needs improvement with a detailed performance and conversion review. ",
    },
    {
      id: 5,
      title: "Migration & Upgrades    ",
      dec: "Move to a new platform or upgrade your existing one without the hassle.  ",
    },
    {
      id: 6,
      title: "Seamless Integrations    ",
      dec: "Connect with the right tools and platforms to grow and reach new markets effortlessly. ",
    },
    {
      id: 7,
      title: "Support & Maintenance    ",
...
export const AreaExpertise = {
  ...
  data: [
    {
      id: 1,
      icon: assets.microicon1,
      title: "Microservices-Based Ecommerce ",
      desc: "Develop scalable ecommerce applications using a microservices architecture, where each component operates independently and connects via REST APIs. This approach ensures flexibility, seamless integration, and better performance.  ",
      url: "",
    },
    {
      id: 2,
      icon: assets.microicon2,
      title: " Ecommerce Portals",
      desc: "Launch robust ecommerce portals to facilitate buyer-seller transactions and enhance the purchasing experience. Our solutions help businesses transition to online channels, implement volume-based pricing, and enable bulk ordering. ",
      url: "",
    },
    {
      id: 3,
      icon: assets.microicon3,
      title: " Online Marketplaces  ",
      desc: "Build and manage your own online marketplace with secure connections to other businesses. Our solutions include inventory management, payment processing, and CRM integration to streamline operations. ",
      url: "",
    },
    {
      id: 4,
      icon: assets.microicon4,
      title: " Mobile Ecommerce Apps",
      desc: "Enhance shopping experiences with feature-rich mobile ecommerce apps. Customers can browse catalogs, create wishlists, add items to their carts, and complete purchases effortlessly. Our solutions ensure secure payment processing, efficient order management, and smooth shipping integration. ",
      url: "",
    },
    {
      id: 5,
      icon: assets.microicon5,
      title: "Headless Commerce ",
      desc: "Leverage the power of headless ecommerce architecture, where the front-end (user experience) and back-end (business logic) operate independently. This provides greater flexibility in choosing technologies and expanding store capabilities. ",
      url: "",
    },
    {
      id:6,
    ...
    {
      id: 7,
      icon: assets.microicon7,
      title: "Point of Sale (POS) Systems  ",
      desc: "Integrate a POS system to accept payments, track sales, and synchronize data in real-time. Our POS solutions ensure seamless transactions and enhanced operational efficiency. ",
      url: "",
    },
    {
      id: 8,
      icon: assets.microicon8,
      title: "Ecommerce CRM  ",
      desc: "Centralize customer data, manage leads, and enhance customer relationships with a robust ecommerce CRM. Our solutions help businesses improve engagement, track interactions, and drive repeat sales. ",
      url: "",
    },
    {
      id: 9,
      icon: assets.microicon9,
      title: "Ecommerce ERP ",
      desc: "Integrate ecommerce operations with Enterprise Resource Planning (ERP) systems to unify back-office processes. Our ERP solutions streamline workflows, enhance efficiency, and improve customer service. ",
      url: "",
    },
  ],
};
