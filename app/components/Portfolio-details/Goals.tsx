        ...
        <>
            <div className='container mx-auto py-4'>
                ...
                >
                            ...
                            <Image src={data?.portfolio[0].section2Image1 ?? assets.goalspic1} alt='image1' width={800} height={900} />
            ...
            <div className=''>
                ...
                >
                    <Image src={data?.portfolio[0].section2BannerImage ?? assets.webmock} alt='web-mockup' width={1500} height={900} className='w-full h-full'/>
                </motion.div>
            </div>
