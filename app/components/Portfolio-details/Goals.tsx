  ...
  return (
    <>
      <div className="container mx-auto py-4">
        {(companyName &&
          companyName !== "bec-arabia" &&
          data?.portfolio.section2Image1) ||
            ...
            companyName !== "bec-arabia" && (
              ...
              >
                {companyName &&
                  ...
                  data.portfolio.section2Image1 && (
                    <Image
                      src={data?.portfolio.section2Image1 || ""}
                      alt="image1"
                      width={800}
                      height={900}
                    />
                ...
                {companyName &&
                  ...
                  data.portfolio.section2Image2 && (
                    <Image
                      src={data?.portfolio.section2Image2 || ""}
                      alt="image1"
                      width={800}
                      height={900}
                    />
        ...
        (data?.portfolio.objectives !== "undefined" &&
          ...
          <div className="lg:pb-150 pb-[50px]">
            ...
            {data?.portfolio.objectives == "undefined" ||
            data?.portfolio.objectives == "<p><br></p>" ||
            data?.portfolio.objectives == "<p>undefined</p>" ? null : (
              <motion.div
      ...
      {data?.portfolio.section2BannerImage ? (
        <div className="">
          <motion.div
            ...
            className="h-[70vh] w-full lg:h-max"
          >
            <Image
      ...
      {data?.portfolio.section !== "case study new" ? (
          ...
          <div className="container mx-auto py-4">
            ...
            >
              <div className="grid space-y-5 py-[50px]  md:space-y-0 lg:grid-cols-2 lg:space-x-5 lg:py-[140px]">
                {data?.portfolio.challenge == "undefined" ||
                data?.portfolio.challenge == "<p>undefined</p>" ||
                data?.portfolio.challenge == "<p><br></p>" ? null : (
                ...
                {data?.portfolio.solutions == "undefined" ||
                data?.portfolio.solutions == "<p>undefined</p>" ||
                data?.portfolio.solutions == "<p><br></p>" ? null : (
                  <div className="flex w-full flex-col bg-dgray px-5 pb-5 pt-5 lg:px-[80px]  lg:pb-[91px] lg:pt-[70px]">
                    <div>
        ...
        <div className="container mx-auto py-4 lg:py-[150px]">
          ...
          >
            <div className="grid space-y-5 py-[50px]  md:space-y-0 lg:grid-cols-2 lg:space-x-5">
              ...
              data?.portfolio.strategyApproach == "<p><br></p>" ? null : (
                <div className="flex w-full flex-col bg-dgray px-5 pb-5 pt-5 lg:px-[80px]  lg:pb-[91px] lg:pt-[70px]">
                  <div>
                    <h2 className="title-65 mb-3 lg:mb-[30px] 3xl:text-nowrap">
                      Strategy & Approach
                    </h2>
                  </div>
                  <div className="text-19 fnt-lexend strategy-approach text-gray1">
