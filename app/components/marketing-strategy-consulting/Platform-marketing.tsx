...
const PlatformMarketing: React.FC<PlatformsSectionProps> = ({
  title,
  data,
  bgblack,
  icontitle,
      ...
      >
        <div>
          ...
          >
            ...
            ></h2>
            <p
              className="text-19 fnt-lexend max-w-[98ch] text-gray1 transition-colors duration-300 group-hover:text-gray-700 "
