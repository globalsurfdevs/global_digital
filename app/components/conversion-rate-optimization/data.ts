...
export const BannerSection = [
  {
    ...
    title: "Conversion Rate Optimization Agency in Dubai",
    subtitle:
      "Maximizing Website Performance through A/B Testing, UX Enhancements, and CRO Strategies",
    navigation: [
      { label: "Home", url: "/" },
      {
  ...
  data: [
    {
      id: 1,
      icon: assets.crmwe1,
      dec: "Maximize Conversions",
    },
    {
      id: 2,
      icon: assets.crmwe2,
      dec: "Optimize User Journey  ",
    },
    {
      id: 3,
      icon: assets.crmwe3,
      dec: "Increase Sales & ROI  ",
    },
    {
      id: 4,
      icon: assets.crmwe4,
      dec: "Custom CRO Strategies    ",
    },
    {
      id: 5,
      icon: assets.crmwe5,
      dec: "Website Optimization  ",
    },
  ],
};
  ...
  data: [
    {
      ...
      dec: "We combine deep analytics, user behavior insights, and A/B testing to craft strategies that maximize conversions.",
    },
    {
      id: 2,
      icon: assets.crmwhy2,
      title: "Proven Success Across Industries",
      dec: "From startups to established enterprises, our CRO expertise has helped businesses increase revenue, leads, and engagement.",
    },
    {
      id: 3,
      icon: assets.crmwhy3,
      title: "End-to-End Optimization",
      dec: "We go beyond audits—from strategy to seamless implementation, we ensure your website converts visitors into loyal customers.",
    },
  ],
};
export const Cta = [
