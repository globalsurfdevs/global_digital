...
const Platforms: React.FC<PlatformsSectionProps> = ({ title, data }) => {
  return (
    <div className="container mx-auto py-4">
      <div className="flex flex-col gap-7 bg-dgray p-[25px] lg:gap-12 lg:p-[100px]">
        <div>
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-[45px] md:grid-cols-2 lg:gap-y-[95px] xl:grid-cols-3">
            {data.map((platform) => (
              ...
              >
                ...
                <div className="relative mb-5 mt-5 h-[1px] overflow-hidden rounded-xl bg-black lg:mb-[43px] lg:mt-[30px]">
                ...
                <div>
                  <p className="text-19 fnt-lexend text-gray1 transition-colors duration-300 group-hover:text-gray-700">
                    {platform.dec}
                  </p>
                </div>
              </div>
