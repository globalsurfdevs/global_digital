  ...
  return (
    <div className="flex flex-col  pb-[0px] lg:pb-[50px]">
      <div className="container  mx-auto  bg-dgray p-[40px] lg:p-[90px]">
        ...
        >
          <h2 className="title-65 mb-[20px] lg:mb-[65px]">
            Elevating the Standards for Our Customer
          </h2>
        </motion.div>
        <motion.div
          initial="hidden"
        ...
        >
          <div className=" grid items-center justify-center gap-5 pt-5 md:grid-cols-2 md:pt-[50px] lg:grid-cols-4">
            <div>
              <div className="text-center ">
                <Image src={assets.seopr1} alt="image" className="m-auto" />
                <p className=" mt-3 text-font19">
                  Increase in <br />
                  CTR
                </p>
              </div>
