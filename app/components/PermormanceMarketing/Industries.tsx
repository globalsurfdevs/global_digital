  ...
  return (
    <div className=" container">
      <div className="  flex flex-col  ">
        <div className=" border-b pb-[30px] pt-[40px] lg:pb-[134px]  lg:pt-[140px]">
          <div className=" container mx-auto text-4xl" ref={nextContainerRef}>
            ...
            >
              <h2 className="title-65 pb-5 lg:pb-[60px]">
                Industries We Serve
              </h2>
            </motion.div>
          </div>
          ...
          >
            <div
              className={`${isSmallScreen ? "container " : ""} ms-auto overflow-hidden`}
