...
export const Frameworkdata = {
  title: "Types of Copywriting Services We Offer  ",
  data: [
    {
      id: 1,
...
export const Platformsecomdata = {
  ...
  desc: "At GS Digital, our team of skilled copywriters and content strategists craft compelling, brand-aligned content that drives results. From website copy and blogs to campaign messaging and SEO content, we bring your brand voice to life with clarity and purpose. ",
  data: [
    {
      id: 1,
      icon: assets.google,
    ...
    },
    {
      ...
      title: "11",
      rsubtitle: "Experts",
      dec: "Dedicated to delivering persuasive, high-performing content that strengthens your brand and connects with your audience. ",
    },
  ],
};
...
export const Cta = [
  {
    textred: "",
    text: "For compelling content that speaks to your audience. ",
  },
];
export const Faq = [
  {
