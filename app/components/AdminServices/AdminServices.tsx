        ...
        <div className="flex items-center justify-between gap-10 px-1">
          <div className="flex items-center gap-10">
            <button
              ...
              className={`text-xl ${view === "services" ? "font-semibold" : "text-gray-400"}`}
            >
              Services
            </button>
            <button
              onClick={() => setView("industries")}
              className={`text-xl ${view === "industries" ? "font-semibold" : "text-gray-400"}`}
            >
              Industries
            </button>
          </div>
                  ...
                  <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div className="relative flex transform flex-col gap-5 overflow-hidden rounded-lg bg-white p-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                      ...
                      <div className="flex flex-col gap-2 text-left">
                        ...
                        />
                        <p className="text-xs text-gray-500">
                          Auto-filled from the name, but you can edit it
                          directly. This becomes part of the page URL, e.g.
                          /services/
                          {newServiceSlug || "your-slug"}
                        </p>
                      </div>
