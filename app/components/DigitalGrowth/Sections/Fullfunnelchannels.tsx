...
const rowOne: ChannelItem[] = [
  ...
  },
  {
    _id: "lockerStudio",
    label: "Looker Studio",
    icon: assets.lockerStudio,
    iconBg: "bg-emerald-50",
  },
  {
    _id: "linkedin",
    label: "LinkedIn Analytics",
    icon: assets.linkedin2,
    iconBg: "bg-[#0A66C2]",
  },
...
const Row = ({
  ...
  return (
    <div className="group relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-12 bg-gradient-to-r from-[#f4f4f4] to-transparent md:w-16" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-24 bg-gradient-to-l from-[#f4f4f4] to-transparent md:w-40 xl:w-56" />
...
const FullFunnelChannels = ({ data }: { data: Props }) => {
  ...
  return (
    <section className="overflow-hidden bg-[#f4f4f4] py-16 text-black md:py-20 xl:py-[90px]">
