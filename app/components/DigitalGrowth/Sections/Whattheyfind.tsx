...
const TABS: TabConfig[] = [
  {
    id: "google",
    label: "A Google search",
    icon: "/images/end-to-end-digitalmarketing/search.svg",
  },
  {
    id: "ai",
    label: "Asking an AI",
    icon: "/images/end-to-end-digitalmarketing/ai.svg",
  },
  {
    id: "report",
    label: "Your monthly report",
    icon: "/images/end-to-end-digitalmarketing/report.svg",
  },
];
...
const CONTENT: Record<TabId, ComparisonRow[]> = {
  google: [
    ...
    {
      before: "A LinkedIn page nobody has touched in a year",
      after: "An active LinkedIn page with twelve posts a month",
    },
    { before: "Your website on page three", after: "Your work on page one" },
    {
      before: "Nothing else on page one",
      after: "Real projects, photographed on site",
    },
  ],
  ai: [
    { before: "It names four competitors", after: "Your company, named" },
    {
      before: "You are not mentioned",
      after: "Clear pages mentioned about your work",
    },
  ...
  report: [
    ...
    {
      before: "No starting point to compare against",
      after: "Where every number came from",
    },
    {
      before: "No explanation when numbers move",
      after: "Why every number moved",
    },
  ],
};
