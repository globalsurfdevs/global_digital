    ...
    <>
      <AdminItemContainer>
        ...
        <div className="flex flex-col gap-2 rounded-md p-5">
          <div className="flex flex-col gap-2">
            ...
            <Input type="text" {...register("seo.metaTitle" as Path<T>)} />
            {/* {seoErrors?.metaTitle && <p className='text-red-500'>{seoErrors.metaTitle.message as string}</p>} */}
          </div>

          <div className="flex flex-col gap-2">
            <Label className="font-bold">Meta Description</Label>
            <Textarea {...register("seo.metaDescription" as Path<T>)} />
      ...
      <AdminItemContainer>
        ...
        <div className="flex flex-col gap-2 rounded-md p-5">
          ...
          />
          {seoErrors?.schema && (
            <p className="text-red-500">{seoErrors.schema.message as string}</p>
          )}
        </div>
      </AdminItemContainer>
    </>
