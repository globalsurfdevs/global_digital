  ...
  return (
    <div className='container mx-auto py-4'>
          ...
          <motion.div
                              ...
                              variants={{
                                ...
                                visible: { opacity: 1, y: 0, transition: { duration: 1, ease: "easeOut" } }, // Slide up and fade in
                                      ...
                                      >
            <div>
                <h1 className='title-65 mb-5'>Result</h1>
            </div>
        ...
        <div className='lg:pt-[136px] lg:pb-[150px] py-[50px] border-b flex flex-col  '>
            <h1 className='title-65 lg:pb-[30px] pb-[20px]'>Lets Create Something Iconic Together</h1>
            <p className='text-19 text-gray1 mb-3 lg-mb-[64px] fnt-lexend'>Every great brand has a story. See how we’ve turned challenges into triumphs for our clients. Your brand could be next. </p>
                <div className='mt-[20px] lg:mt-[64px]'><Button text='LET&apos;S COLLABORATE' /></div>
              </div>
