  ...
  return (
    <>
      <div className="container mx-auto py-4">
        ...
        >
          <div className="flex flex-col items-center  gap-4 pb-[50px] pt-[20px] sm:pt-[50px] lg:pt-[130px] xl:grid xl:grid-cols-8">
            ...
            <div className="flex h-full w-full   items-center pb-0 pt-4   lg:col-span-6 lg:py-4 xl:col-span-5">
              <p className="text-30 text-gray1">
                Each case study reflects our focus on measurable growth —
                translating strategy and creativity into tangible business
                value.
              </p>
            </div>
          </div>
