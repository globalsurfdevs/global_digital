...
export const Faq = [
  ...
  }, 
  {
    ...
    description:
      "Yes, when executed strategically. Early-stage visibility ensures decision-makers discover and evaluate vendors before tenders are issued. Authority-led SEO and intent-based advertising reinforce credibility during evaluation. A strong digital presence increases shortlist consideration throughout competitive procurement processes.",
  }, 
  {
    title: "How can digital marketing accelerate real estate sales in Dubai?",
    description:
      "In Dubai’s fast-moving market, we use hyperlocal SEO, AI-driven lead scoring, and performance media to capture high-intent buyers early. This shortens decision cycles, improves lead quality, and maximizes off-plan and secondary sales through precise targeting and conversion-focused landing pages.",
  }, 
  {
    title: "Why does a growth audit the first step with Global Surf?",
    description:
      "Our growth audit uncovers hidden opportunities, benchmarks competitors, sizes realistic demand, and maps KPIs directly to revenue goals. This strategic clarity ensures every campaign dollar delivers accountable results, avoiding wasted spend on unproven tactics. Book your free audit today to see the difference.",
  }, 
