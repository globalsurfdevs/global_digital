      ...
      >
        <div className="mb-[50px] flex flex-col gap-5 border-b py-[50px] lg:mb-8  lg:pb-[150px] lg:pt-[136px]">
          ...
          <p className="font-35 max-w-[50ch]">
            We’re Global Surf Digital, a full-service digital marketing company in Dubai, specializing in data-driven strategies, creative innovation, and business-focused solutions.
          </p>
          <button
