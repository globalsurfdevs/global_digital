        ...
        {testimonials.map((item, index) => (
          ...
          className="mb-2  md:mb-4  lg:mb-8" >
            <div className={`flex flex-col  ${lexend.className}`}>
              <div className="flex flex-col   border-b border-black pt-[20px] lg:pt-[65px] mb-6 lg:mb-[41px]">
                <Image src={item.image} alt="image" className="w-20 h-20 bg-white p-1 mb-4 lg:mb-[30px]"></Image>
                ...
                <Image src={item.logo} alt="image" className="mb-5 lg:mb-[26px] "  ></Image>
              </div>
