...
const Expertise: React.FC<ExpertiseSectionProps> = () => {
  return (
    <div className="container mx-auto py-4">
      <div className="py-120 flex flex-col  justify-between border-b  lg:flex-row">
        ...
        <div className="lg:w-5/12">
          ...
          <p className="text-19 fnt-lexend  py-6 text-muted lg:py-[30px] ">
            We&rsquo;re GS Digital, a full-service digital marketing agency in
            Dubai delivering digital marketing services to brands across the
            UAE. With extensive experience across construction, real estate,
            B2B, education, retail, and other key industries, we work with
