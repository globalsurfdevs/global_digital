...
export const SuccessStoriesPortfolio = ({ companyId, colCount }: {
    ...
    return (
        <div className='  flex flex-col py-10  lg:py-[80px] xl:py-[100px]  2xl:py-[140px]'>
            ...
            > 
<div className={`${colCount ? `grid lg:grid-cols-${colCount}` : 'grid lg:grid-cols-3'} gap-8`}>
  ...
  ? (colCount === 2 ? data.slice(0, 2) : data).map((item, index) => (
      <div className='flex flex-col relative group' key={index}>
        ...
        <div className='card-img h-[250px] lg:h-[300px] xl:h-[450px] 2xl:h-[580px] relative mb-4 lg:mb-[31px]'>
          ...
          <div className="absolute left-3 top-3 lg:left-7 lg:top-7 cursor-pointer rounded-3xl bg-gray1 px-4 py-2 duration-200 ease-in-out group-hover:z-[1] group-hover:-translate-x-[-3px] group-hover:bg-primary group-hover:shadow-lg ">
        ...
        <div className='flex items-center justify-between'>
          ...
          <div>
            ...
            >
              <path d="M33.8105 1.7998L1.25781 33.7227" stroke="currentColor" strokeWidth="2" />
              <path d="M1.25781 1.7998H33.8105V33.0929" stroke="currentColor" strokeWidth="2" />
            </svg>
          </div>
        </div>

        <div className='bg-[#E6E6E6] h-[2px] w-full mt-2 lg:mt-5 group-hover:bg-primary transition-colors duration-300'></div>
