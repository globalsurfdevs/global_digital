                ...
                <div className='h-full grid grid-cols-2 w-full'>
                    <div className='flex h-full w-full'>
                        ...
                        <div className="flex flex-col justify-between p-4 leading-normal items-center">
                            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{item.section == 'portfolio' || 'case study new' ? item.companyName : item.heading}</h5>
                        </div>
                    </div>
