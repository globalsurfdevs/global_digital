                  ...
                  <tr>
                    {columnTitles.map((colTitle, index) => (
                      <th
                        key={index}
                        scope="col"
                        className={`px-6 py-3 text-left text-font19 font-medium text-dark capitalize tracking-wider ${index < columnTitles.length - 1 ? 'border-r border-gray-200' : ''
                          }`}
                      >
                        {colTitle}
                      </th>
                  ...
                  {data.map((row, index) => (
                    <tr key={index}>
                      {columnTitles.map((colTitle, colIndex) => (
                        <td
                          key={colIndex}
                          className={`px-6 py-4 ${colIndex < columnTitles.length - 1 ? 'border-r border-gray-200' : ''
                            }`}
                        >
