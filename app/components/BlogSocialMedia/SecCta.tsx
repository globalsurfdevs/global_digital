          ...
          <div className="grid grid-cols-1">
            ...
            <div className="col-span-5 w-full">
              <p className="mt-4 text-font19 text-[#77787B]">
                Working on search engine visibility for your construction brand
                in the UAE?{" "}
                <a
                ...
                that helps built environment companies turn construction SEO
                into qualified enquiries, not just traffic. If your site is
                ranking for the wrong terms, or not ranking at all, we can show
