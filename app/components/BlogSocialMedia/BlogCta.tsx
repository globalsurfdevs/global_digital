          ...
          <div className="grid grid-cols-1">
            ...
            <div className="col-span-5 w-full">
              <h2 className="title-65 mb-5 lg:mb-[40px]">
                Ready to Understand What Performance Marketing Can Deliver for
                Your Business?
              </h2>
              <p className="mt-4 text-font19 text-[#77787B]">
                If you are evaluating performance marketing for your UAE
                business and want an honest assessment of what it could generate
                based on your sector, your target audience, and your current
                digital baseline that conversation starts with a no-obligation
                audit.
              </p>
