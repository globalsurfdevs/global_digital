      ...
      <div className="py-24 flex flex-col gap-12">
        ...
        <div className="grid grid-cols-3 gap-8">
          {stories.map((item, index) => (
            <div className="bg-black h-[600px] group ease-in-out duration-300 text-white hover:translate-y-[-5px] hover:cursor-pointer ease-in-out duration-500" key={index}>
              <div className="bg-gray-500 h-[45%] flex flex-col gap-5 justify-center px-12 group-hover:bg-primary ease-in-out duration-500">
                <div className="relative">
                  ...
                  <div className="absolute top-0 right-0 hidden group-hover:block ease-in-out duration-500">
                    <svg width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M33.8125 1.7998L1.25977 33.7227" stroke="white" strokeWidth="2" stroke-miterlimit="10" />
                      <path d="M1.25977 1.7998H33.8125V33.0929" stroke="white" strokeWidth="2" stroke-miterlimit="10" />
                    </svg>
                  </div>
                </div>
              </div>
