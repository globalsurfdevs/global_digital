...
const SuccessStories = () => {
  return (
    <div className="container px-4 mx-auto">
      <div className="py-6 md:py-24 flex flex-col gap-12">
        <h1 className="text-font65">Browse our Success Stories</h1>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {stories.map((item, index) => (
            <div className="bg-black xl:h-[600px] group ease-in-out duration-300 text-white hover:translate-y-[-5px] hover:cursor-pointer ease-in-out duration-500" key={index}>
              <div className="bg-gray-500 py-6 h-[45%] flex flex-col gap-5 justify-center px-8 md:px-12 group-hover:bg-primary ease-in-out duration-500">
