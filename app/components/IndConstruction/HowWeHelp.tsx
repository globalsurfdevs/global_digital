...
const HowWeHelp: React.FC<PlatformsSectionProps> = ({
  title,
  data,
  bgblack,
  icontitle,
  ...
  return (
    <div className="mt-[50px] lg:mt-[140px]">
      <div className={`container mx-auto  py-4  ${leftzero ? "relative" : ""}`}>
        ...
        >
          <div>
            ...
            >
              <h2
                className={`title-65 mb-1 max-w-[28ch] xl:mb-10 ${bgblack ? "text-white" : ""}`}
              >
                {title}{" "}
              </h2>
              <p
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-[45px] md:grid-cols-2 lg:gap-y-[95px] xl:grid-cols-3">
              {data.map((platform) => (
                ...
                >
                  ...
                  >
                    <p
                      className={`text-30 max-w-[16ch] transition-colors duration-300 group-hover:text-primary ${bgblack ? "text-white" : ""}`}
                    >
                      {platform.title}
                    </p>
                    <p
                      className="max-w-[15ch] text-right text-font25 leading-[1.3] text-[#77787B]"
                  ...
                  <div>
                    <p
                      className={`xl:text-19 fnt-lexend text-[16px] text-gray1 transition-colors duration-300 group-hover:text-gray-700 ${bgblack ? "group-hover:text-gray-300" : ""}`}
                    >
                      {platform.dec}
                    </p>
                  </div>
