...
import PlatformSwiper from "../../components/PpcAdvertisingAgencyDubai/PlatformSwiper";
...
const SliderInd: React.FC<PlatformsSectionProps> = ({ Platformsdata }) => {
  return (
    <div>
