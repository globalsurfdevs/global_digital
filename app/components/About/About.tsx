            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                {errors.firstSection?.video && (
                  <p className="text-red-500">
                    {errors.firstSection?.video.message}
                  </p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2 flex justify-end">
                <Button
                  ...
                  addItem
                  onClick={() =>
                    thirdSectionAppend({ image: "", imageAlt: "", title: "" })
                  }
                >
                  Add Item
                </Button>
            ...
            <div>
              ...
              <div className="mt-2 flex justify-end">
                <Button
                  ...
                  addItem
                  onClick={() =>
                    fourthSectionAppend({ description: "", title: "" })
                  }
                >
                  Add Item
                </Button>
          ...
          <div className="flex flex-col gap-2 rounded-md p-5">
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-2">
                ...
                />
                {errors.teamSection?.title && (
                  <p className="text-red-500">
                    {errors.teamSection?.title.message}
                  </p>
                )}
              </div>
            </div>
                  ...
                  >
                    {teamSectionItems.map((field, index) => (
                      ...
                      >
                        {reorderMode ? (
                          <span className="font-medium">
                            {watch(`teamSection.items.${index}.name`) ||
                              `Member ${index + 1}`}
                          </span>
                        ) : (
                          <>
                            <div className="absolute right-2 top-2">
                              <RiDeleteBinLine
                                onClick={() => teamSectionRemove(index)}
                                className="cursor-pointer text-red-600"
                              />
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <div className="flex flex-col gap-2">
                                ...
                                <Input
                                  ...
                                  placeholder="Alt Tag"
                                  {...register(
                                    `teamSection.items.${index}.imageAlt`,
                                    {
                                      required: "Alt Tag is required",
                                    },
                                  )}
                                />
                                {errors.teamSection?.items?.[index]
                                  ?.imageAlt && (
                                  <p className="text-red-500">
                                    {
                                      errors.teamSection?.items?.[index]
                            ...
                            <div className="flex flex-col gap-2">
                              <div className="flex flex-col gap-2">
                                ...
                                <Input
                                  ...
                                  placeholder="Name"
                                  {...register(
                                    `teamSection.items.${index}.name`,
                                    {
                                      required: "Name is required",
                                    },
                                  )}
                                />
                                {errors.teamSection?.items?.[index]?.name && (
                                  <p className="text-red-500">
                                    {
                                      errors.teamSection?.items?.[index]?.name
                                        .message
                              ...
                              <div className="flex flex-col gap-2">
                                ...
                                <Input
                                  ...
                                  {...register(
                                    `teamSection.items.${index}.designation`,
                                    {
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  type="text"
                  placeholder="Title"
                  {...register(`lastSection.title`, {
                    required: "Value is required",
                  })}
                />
                {errors.lastSection?.title && (
                  <p className="text-red-500">
                    {errors.lastSection?.title.message}
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Textarea
                  placeholder="Description"
                  {...register("lastSection.description", {
                    required: "Description is required",
                  })}
                />
                {errors.lastSection?.description && (
                  <p className="text-red-500">
                    {errors.lastSection?.description.message}
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Input
                  ...
                  {...register("lastSection.buttonText", {
                    required: "Button Text is required",
                  })}
                />
                {errors.lastSection?.buttonText && (
                  <p className="text-red-500">
                    {errors.lastSection?.buttonText.message}
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Input
                  ...
                  {...register("lastSection.buttonLink", {
                    required: "Button Link is required",
                  })}
                />
                {errors.lastSection?.buttonLink && (
                  <p className="text-red-500">
                    {errors.lastSection?.buttonLink.message}
                  </p>
                )}
              </div>
            </div>
