    ...
    try {
      ...
      if (response.ok) {
        ...
        setValue(
          ...
          data.data?.testimonialSection?.items ?? [],
        );
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  type="text"
                  placeholder="Title"
                  {...register(`clientSection.title`, {
                    required: "Value is required",
                  })}
                />
                {errors.clientSection?.title && (
                  <p className="text-red-500">
                    {errors.clientSection?.title.message}
                  </p>
                )}
              </div>
            </div>
            <div>
                      ...
                      >
                        {reorderMode ? (
                          <span className="font-medium">
                            {watch(`clientSection.items.${index}.imageAlt`) ||
                              `Item ${index + 1}`}
                          </span>
                        ) : (
                          <>
                            <div className="absolute right-2 top-2">
                              <RiDeleteBinLine
                                onClick={() => clientSectionRemove(index)}
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <Input
                                ...
                                placeholder="Alt Tag"
                                {...register(
                                  `clientSection.items.${index}.imageAlt`,
                                  {
                                    required: "Alt Tag is required",
                                  },
                                )}
                              />
                              {errors.clientSection?.items?.[index]
                                ?.imageAlt && (
                                <p className="text-red-500">
                                  {
                                    errors.clientSection?.items?.[index]
              ...
              <div className="mt-2 flex justify-end">
                <Button
                  ...
                  addItem
                  onClick={() =>
                    clientSectionAppend({ image: "", imageAlt: "" })
                  }
                >
                  Add Item
                </Button>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  type="text"
                  placeholder="Title"
                  {...register(`testimonialSection.title`, {
                    required: "Value is required",
                  })}
                />
                {errors.testimonialSection?.title && (
                  <p className="text-red-500">
                    {errors.testimonialSection?.title.message}
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  ...
                  {...register(`testimonialSection.starText`, {
                    required: "Star Text is required",
                  })}
                />
                {errors.testimonialSection?.starText && (
                  <p className="text-red-500">
                    {errors.testimonialSection?.starText.message}
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  ...
                  {...register(`testimonialSection.bottomText`, {
                    required: "Bottom Text is required",
                  })}
                />
                {errors.testimonialSection?.bottomText && (
                  <p className="text-red-500">
                    {errors.testimonialSection?.bottomText.message}
                  </p>
                )}
              </div>
            </div>
                  ...
                  >
                    {testimonialSectionItems.map((field, index) => (
                      ...
                      >
                        {reorderMode ? (
                          <span className="font-medium">
                            {watch(`testimonialSection.items.${index}.name`) ||
                              `Testimonial ${index + 1}`}
                          </span>
                        ) : (
                          <>
                            <div className="absolute right-2 top-2">
                              <RiDeleteBinLine
                                onClick={() => testimonialSectionRemove(index)}
                                className="cursor-pointer text-red-600"
                              />
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                              <div className="flex flex-col gap-2">
                                ...
                                />
                                {errors.testimonialSection?.items?.[index]
                                  ?.image && (
                                  <p className="text-red-500">
                                    {
                                      errors.testimonialSection?.items?.[index]
                              ...
                              <div className="flex flex-col gap-2">
                                ...
                                <Input
                                  ...
                                  placeholder="Alt Tag"
                                  {...register(
                                    `testimonialSection.items.${index}.imageAlt`,
                                    {
                                      required: "Alt Tag is required",
                                    },
                                  )}
                            ...
                            <div className="flex flex-col gap-2">
                              <div className="flex flex-col gap-2">
                                ...
                                <Input
                                  ...
                                  placeholder="Name"
                                  {...register(
                                    `testimonialSection.items.${index}.name`,
                                    {
                              ...
                              <div className="flex flex-col gap-2">
                                ...
                                <Input
                                  ...
                                  {...register(
                                    `testimonialSection.items.${index}.designation`,
                                    {
                            ...
                            <div className="col-span-2 flex flex-col gap-2">
                              ...
                              <Textarea
                                placeholder="Message"
                                {...register(
                                  `testimonialSection.items.${index}.message`,
                                  {
                              ...
                              />
                              {(() => {
                                const messageError = errors.testimonialSection
                                  ?.items?.[index]?.message as
                            ...
                            <div className="flex flex-col gap-2">
                              <Label className="font-bold">
                                Company Logo Alt Tag
                              </Label>
                              <Input
                                type="text"
                                placeholder="Company Logo Alt Tag"
                                {...register(
                                  `testimonialSection.items.${index}.companyLogoAlt`,
                                  {
                                    required:
                                      "Company Logo Alt Tag is required",
                                  },
                                )}
                              />
                              {errors.testimonialSection?.items?.[index]
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <Input
                                ...
                                {...register(
                                  `testimonialSection.items.${index}.companyName`,
                                  {
          ...
          <div className="flex flex-col gap-2 rounded-md p-5">
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-2">
                ...
                />
                {errors.faqSection?.title && (
                  <p className="text-red-500">
                    {errors.faqSection?.title.message}
                  </p>
                )}
              </div>
            </div>
                        ...
                        {reorderMode ? (
                          ...
                          <>
                            ...
                            <div className="col-span-2 flex flex-col gap-2">
                              ...
                              />
                              {errors.faqSection?.items?.[index]?.answer && (
                                <p className="text-red-500">
                                  {
                                    errors.faqSection?.items?.[index]?.answer
                                      .message
