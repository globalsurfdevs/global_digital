...
import { BannerSection,Wecanhelp,OurServices,Frameworkdata,Platformsecomdata,Cta,Faq,relatedservices} from "../../data/services/wdd-mobile-apps/data";
...
interface Canonicals {
 ...
 export async function generateMetadata(): Promise<Metadata> {
   return {
     ...
     alternates: {
       canonical: "https://www.globalsurf.ae/mobile-app-development-company-dubai",
     },
     robots: "index, follow",
     openGraph: {
       title: "Mobile App Development Company in Dubai |  iOS, Android, & Hybrid Development",
