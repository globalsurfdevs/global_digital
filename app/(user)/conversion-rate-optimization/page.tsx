...
import { BannerSection,Wecanhelp,OurServices,Platformimgmdata,Cta,Faq,relatedservices ,Frameworkdata} from "../../components/conversion-rate-optimization/data";
...
const page = () => {
  return (
    <div>
      ...
      <section className="pb-[50px]   lg:pb-[140px] ">
        <Platformimg title={Platformimgmdata.title} desc={Platformimgmdata.desc} data={Platformimgmdata.data}    colcount={3} />
        </section>
