    ...
    <div>
      ...
      <section className="py-140">
        <div className="container">
          <div className="flex flex-col gap-5 border-b border-black/10 pb-5 lg:gap-75 lg:pb-75">
            <h2 className="text-font65 font-normal leading-[1.076923076923077]">
              For Your Business, Your Market, Your Goals Cut Through the Noise.
              Capture More Value.
            </h2>
            <div>
              <p className="fnt-lexend mb-6 text-font19 font-medium leading-[1.473684210526316] text-gray1 lg:mb-10">
                We help brands grow in Kuwait’s fast-evolving digital landscape
                through clear strategy, precise targeting, and performance that
                matters. With a focus on measurable results, we create digital
                experiences that engage, convert, and scale.
              </p>
              <h3 className="fnt-lexend text-font19 font-semibold leading-[1.473684210526316]">
                Strategically driven. Data-backed.
              </h3>
              <p className="fnt-lexend mb-0 text-font19 font-medium leading-[1.473684210526316] text-gray1">
                No guesswork—just powerful execution that delivers ROI.
              </p>
            </div>
      ...
      <section className="py-140">
        <FeaturedProjectsSlider
          FeaturedProjectsdata={featuredProjectsdata.filter(
            (item) => item !== undefined,
          )}
      ...
      />
      <PartnersSec />
      <section className="pt-12 lg:pt-140">
        <Platformserver
      ...
      <Industydetail
        title={relatedServicesData.title}
        data={relatedServicesData.data}
        colnum={3}
      />
