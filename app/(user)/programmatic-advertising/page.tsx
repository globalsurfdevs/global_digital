...
import { BannerSection,Wecanhelp,OurServices,Platformimgmdata,Cta,Faq,relatedservices ,Frameworkdata} from "../../components/programmatic-advertising/data";
  ...
  return (
    <div>
      ...
      <section className="pb-[50px]   lg:pb-[140px] ">
        ...
        <RelatedServices title={relatedservices.title} bgcolor={'black'} text="white"  data={relatedservices.data} colcount={3} />
