    ...
    <div className="container mx-auto py-4">
      <div className="pt-[30px] lg:pt-[100px] ">
        ...
        <p className="text-19 text-gray1">
          We are seeking a motivated and results-driven professional to join our
          team.
        </p>
        <div className="  pb-[40px] pt-[15px] lg:pb-[50px] lg:pt-[50px]">
          <form
            action="https://forms.zohopublic.com/Globalsurf/form/GlobalsurfCareerForm1/formperma/9ItYPvjmFDbF9ve90H81K2Yp-Ht-6Xpx7-2f49b7ook/htmlRecords/submit"
            name="form"
            id="form"
            method="POST"
            acceptCharset="UTF-8"
          ...
          >
            ...
            <button
              type="submit"
              className="w-fit rounded-[55px] bg-primary px-[40px] py-[10px]  font-medium text-white transition duration-300 ease-in-out hover:bg-dgray hover:text-primary md:px-[40px]  md:py-[10px] "
            >
              Submit
            </button>
          </form>
