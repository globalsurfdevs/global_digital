...
import {
  ...
  Faq,
  contentSectionsData,
  UAEBuiltEnvironmentData,
  videoProductionsocialData,
  builtEnvironmentData,
  trendsData,
  keySectorsData,
  contractorMarketingData,
  digitalTechnologyData,
  understandingBuiltEnvironmentData,
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title:
      "What Is the Built Environment in UAE? A Practical Guide | GS Digital ",
    description:
...
const page = async () => {
  ...
  return (
    <div className="relative">
      ...
      <section
        className="pt-[50px] lg:pt-[100px]"
        id="navigating-uaes-built-environment-regulations"
      >
        <ThreeColumnTable
