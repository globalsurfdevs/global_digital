...
import {
  ...
  contentSectionsData,
  Faq,
} from "../../../data/blogdatas/whatIsPerformanceMarketing";
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: {
      canonical:
        "https://www.globalsurf.ae/blogs/what-is-performance-marketing-and-how-it-works",
    },
    robots: "index, follow",
    openGraph: {
      ...
      description:
        "Understand performance marketing for UAE businesses — channels, costs in AED, what results to expect, and how to choose the right agency in Dubai or Abu Dhabi.",
    },
  };
}
