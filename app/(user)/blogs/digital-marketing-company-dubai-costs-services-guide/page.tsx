...
import { BannerSection, contentSectionsData, Faq, ctaData } from "../../../data/blogdatas/DigitalMarketingData";
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Digital Marketing Company in Dubai Costs, Services, and How to Choose the Right Agency",
    description: "Compare digital marketing agency costs in Dubai, freelancer vs agency options, key services, pricing models, and contract lengths to choose the right partner for growth",
    alternates: { canonical: "https://www.globalsurf.ae/blogs/digital-marketing-company-dubai-costs-services-guide", },
    robots: "index, follow",
    openGraph: {
      title: "Digital Marketing Company in Dubai: Costs, Services & How to Choose",
      site_name: "Global Surf",
      url: "https://www.globalsurf.ae/blogs/digital-marketing-company-dubai-costs-services-guide",
      description: "A practical guide to digital marketing agencies in Dubai – costs, services, pricing models, and how to pick a reliable partner for long - term growth.",
    },
  };
}
