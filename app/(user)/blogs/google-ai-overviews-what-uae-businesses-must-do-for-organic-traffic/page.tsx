...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title:
      "Google AI Overviews UAE: How to Protect Your Organic Traffic | GS Digital ",
    description:
    ...
    alternates: {
      canonical:
        "https://www.globalsurf.ae/blogs/google-ai-overviews-what-uae-businesses-must-do-for-organic-traffic",
    },
    robots: "index, follow",
    openGraph: {
