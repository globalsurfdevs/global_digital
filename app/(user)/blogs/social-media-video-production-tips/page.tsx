...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title:
      "Social Media Video Production: 2026 Guide for TikTok, Reels & Shorts | Global Surf ",
    description:
    ...
    alternates: {
      canonical:
        "https://www.globalsurf.ae/blogs/social-media-video-production-tips",
    },
    robots: "index, follow",
    openGraph: {
      title:
        "How Digital Marketing Wins Projects for Construction Companies in UAE",
...
const page = () => {
  ...
  const platformCheatSheetTitles = [
    "Platform",
    "Length",
    "Format",
    "Best Time",
  ...
  const schemaData = {
    ...
    "@type": "Article",
    headline:
      "Social Media Video Production: 2026 Guide for TikTok, Reels & Shorts",
    author: {
      "@type": "Person",
      name: "Ashna Ganeeva",
    },
  ...
  return (
    <div className="relative">
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "A social media video production company handles everything from content planning and scripting to filming, editing, and publishing. They specialize in creating videos tailored to social platforms and often help with strategy, platform optimization, and performance tracking.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "If you're scaling your content or want consistent, high-quality output, working with a social media video production company or agency can save time and improve results. Agencies often offer editing, strategy, and platform optimization as a package.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Track metrics like views, engagement rate (likes, comments, shares), watch time, reach, and click-through rates. On platforms like Instagram or YouTube, you can also use Insights/Analytics tools for deeper reporting.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "An effective social video grabs attention within the first few seconds, tells a compelling story, is optimized for mobile viewing, includes captions, and ends with a strong call-to-action (CTA). It should also align with your brand voice and appeal to your target audience.",
                },
              },
            ],
          }),
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            step: [
              {
                "@type": "HowToStep",
                text: "Plan your video concept and identify the target platform.",
              },
              {
                "@type": "HowToStep",
                text: "Record the video with clear visuals and strong lighting.",
              },
              {
                "@type": "HowToStep",
                text: "Edit the footage using trending sounds, captions, and effects.",
              },
              {
                "@type": "HowToStep",
                text: "Upload with an optimized caption, hashtags, and thumbnail.",
              },
              {
                "@type": "HowToStep",
                text: "Monitor performance and adjust content strategy accordingly.",
              },
            ],
          }),
        }}
      ...
      <EssentialTips
        tipsData={videoTips}
        title="Essential Tips for Creating Engaging Video Content"
      />
      <Troubleshooting
        title="Troubleshooting Common Issues"
        gridCols={troubleshootingData.gridCols}
        issues={troubleshootingData.issues}
      />
