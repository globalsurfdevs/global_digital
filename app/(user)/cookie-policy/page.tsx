...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: "Legal cookie policy for GS Digital.",
    alternates: {
          ...
          <div className=" mb-5 grid grid-cols-1 gap-2">
            ...
            <div>
              ...
              <ul className="list-outside list-disc pl-[60px]">
                <li>
                  These cookies are necessary for the core functionality of our
                  website. Without them, certain features may not work.
                </li>
              </ul>
              ...
              <ul className="list-outside list-disc pl-[60px]">
                <li>
                  ...
                  our website by collecting data on user behaviour and site
                  performance.
                </li>
              </ul>
              ...
              <ul className="list-outside list-disc pl-[60px]">
                <li>
                  These cookies deliver relevant advertisements based on your
          ...
          <div className=" mb-5 grid grid-cols-1 gap-2">
            ...
            <div>
              <ul className="list-outside list-disc pl-[40px]">
                ...
                <li>
                  Analyze site traffic and user interactions to optimize our
                  content.
                </li>
              </ul>
            </div>
          ...
          <div className=" mb-5 grid grid-cols-1 gap-2">
            ...
            <div>
              <p>
                ...
                such as analytics providers or advertisers. We do not control
                these cookies and recommend reviewing their respective
                policies.{" "}
              </p>
            </div>
          </div>
          <div className=" mb-5 grid grid-cols-1 gap-2">
            ...
            <div>
              <p>
                ...
                affect the functionality of our website. For more information on
