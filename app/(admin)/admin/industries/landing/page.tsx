...
const IndustryLandingPage = () => {
    ...
    const { register, handleSubmit, setValue, watch, control, formState: { errors } } = useForm<IndustryLandingFormProps>();
    ...
    return (
        <div className='flex flex-col gap-5 pb-5'>
            <form className='flex flex-col gap-5' onSubmit={handleSubmit(handleAddIndustryLanding)}>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-2'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className='flex flex-col gap-2'>
                                ...
                                <Input type='text' placeholder='Last Card Title' {...register(`thirdSection.lastCardTitle`, {
                                    required: "Last Card Title is required"
                                })} />
                                {errors.thirdSection?.lastCardTitle && <p className='text-red-500'>{errors.thirdSection?.lastCardTitle.message}</p>}
                            </div>

                            <div className='flex flex-col gap-1'>
                                <Label className=' font-bold'>Last Card Description</Label>
                                <Textarea placeholder='Last Card Description' {...register("thirdSection.lastCardDescription", {
                                    required: "Last Card Description is required"
                                })} />
                                {errors.thirdSection?.lastCardDescription && <p className='text-red-500'>{errors.thirdSection?.lastCardDescription.message}</p>}
                            </div>
                                            ...
                                            <SortableItem key={field.id} id={field.id} reorderMode={reorderMode}>
                                                {reorderMode ? (
                                                    <span className='font-medium'>
                                                        {watch(`caseStudySection.items.${index}.title`) || `Item ${index + 1}`}
                                                    </span>
                                                ) : (
                                                    <>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-2'>
                        ...
                        <div>
                            ...
                            <div className='border border-black/20 p-2 rounded-md flex flex-col gap-5'>
                                ...
                                <DndContext collisionDetection={closestCorners} onDragEnd={createDragEndHandler(servicesSectionItems, servicesSectionMove)}>
                                    <SortableContext
                                    ...
                                    >
                                        {servicesSectionItems.map((field, index) => (
                                            <SortableItem key={field.id} id={field.id} reorderMode={reorderMode}>
                                                {reorderMode ? (
                                                    <span className='font-medium'>
                                                        {watch(`servicesSection.items.${index}.title`) || `Item ${index + 1}`}
                                                    </span>
                                                ) : (
                                                    <>
                                                        <div className='absolute top-2 right-2'>
                                                        ...
                                                        <div className='flex flex-col gap-2'>
                                                            ...
                                                            <Input
                                                                type='text'
                                                                placeholder='Title'
                                                                {...register(`servicesSection.items.${index}.title`)}
                                                            />
                                                        </div>
                                                        ...
                                                        <div className='flex flex-col gap-2'>
                                                            ...
                                                            <Textarea
                                                                placeholder='Description'
                                                                {...register(`servicesSection.items.${index}.description`)}
                                                            />
                                                        </div>
                            ...
                            <div className='flex justify-end mt-2'>
                                <Button type='button' addItem onClick={() => servicesSectionAppend({ service: "", title: "", description: "", image: "", imageAlt: "" })}>Add Item</Button>
                            </div>
                        </div>
                    </div>
                </AccordionSection>
                ...
                <SeoFields<IndustryLandingFormProps> control={control} register={register} errors={errors} />
